...
public partial class PokerAniSystem : SystemBase
{
    ...
    Dictionary<int, List<CardAnimationItem>> colNodes_Dic = new TSMap<int, TSArray<CardAnimationItem>>();
    ...
    void updateAnimation(PokerAnimationComponentData entity, LocalTransform lt, float dt)
    {
        if (!entity.open)
        {
            return;
